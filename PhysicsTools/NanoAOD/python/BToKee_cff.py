...
BToKee=cms.EDProducer("BToKeeProducer",
                      ...
                      LeadElectronMinPt=cms.double(1.),
                      LeadElectronMaxEta=cms.double(2.4),
                      SubLeadElectronMinPt=cms.double(0.5),
                      SubLeadElectronMaxEta=cms.double(2.4),                      
                      KaonMinPt=cms.double(0.5),
