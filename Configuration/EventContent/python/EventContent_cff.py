...
RECOSIMEventContent.outputCommands.append('keep *_electronCkfTrackCandidates_*_*')
RECOSIMEventContent.outputCommands.append('keep *_gedGsfElectronsTmp_*_*')
RECOSIMEventContent.outputCommands.append('keep *_pfTrackElec_*_*')
RECOSIMEventContent.outputCommands.append('keep *_particleFlowEGamma_*_*')
